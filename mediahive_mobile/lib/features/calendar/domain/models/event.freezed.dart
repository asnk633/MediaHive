...
// Store color as int for serialization
  ...
  @override
  String toString() {
    return 'Event(id: $id, title: $title, time: $time, type: $type, date: $date, colorValue: $colorValue, description: $description, location: $location)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, time, type, date,
      colorValue, description, location);

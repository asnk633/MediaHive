...
import { MemberGuideModal } from '@/components/onboarding/MemberGuideModal';
                    ...
                    <div className="space-y-4 flex-1">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-sm text-muted-foreground leading-relaxed">Members can request tasks and events directly.</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <div className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-2 shrink-0" />

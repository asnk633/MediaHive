...
export const DeliverableUploadModal: React.FC<DeliverableUploadModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div
                className="bg-[#1a2639] rounded-2xl w-full max-w-md border border-white/10 shadow-2xl overflow-hidden"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-colors"

...
export const StatusChart = ({ stats }: StatusChartProps) => {
    ...
    if (!isReady) {
        return (
            <div className="bg-surface backdrop-blur-md rounded-[18px] p-5 shadow-xl h-[350px] animate-pulse" />
        );
    }

    if (activeData.length === 0) {
        return (
            <div className="bg-surface backdrop-blur-md rounded-[18px] p-5 shadow-xl h-[350px] flex items-center justify-center">
    ...
    return (
        <div className="bg-surface backdrop-blur-md rounded-[18px] p-5 shadow-xl flex flex-col h-[350px]">

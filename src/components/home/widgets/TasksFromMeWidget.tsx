    ...
    if (myTasks.length === 0) {
        return (
            <div className="space-y-6">
                ...
                <div className="p-6 bg-white/5 backdrop-blur-md rounded-2xl border border-white/5 text-center">
                ...
                {myTasks.map(task => {
                    ...
                    return (
                        <div key={task.id} className={`group flex items-center justify-between p-4 bg-white/5 backdrop-blur-md rounded-2xl border border-white/5 hover:bg-white/10 hover:border-[#ffffff1a] transition-all duration-300 ${isDone ? 'opacity-50 grayscale' : ''}`}>
                            ...
                            <div className={`px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider border whitespace-nowrap ${getStatusColor(task.status)}`}>

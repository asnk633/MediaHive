...
export default function NewEventPage() {
    ...
    return (
        <div className="min-h-full flex items-center justify-center py-6 px-4 sm:px-6 relative bg-background">
            {/* Centered Glass Card */}
            <div className="w-full max-w-xl relative z-10">
                <div className="bg-surface/90 backdrop-blur-3xl border border-soft rounded-3xl p-6 sm:p-8 shadow-2xl ring-1 ring-soft">
                    ...
                    <div className="flex items-center justify-between mb-8 pb-4 border-b border-soft">
                        ...
                        <h1 className="text-lg font-bold text-foreground tracking-wide">New Event</h1>
                        {/* Spacer for balance */}

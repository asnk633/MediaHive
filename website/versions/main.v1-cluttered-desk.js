...
function createDesktopTexture() {
  ...
  ctx.fillText('≡ƒÉ¥ MediaHive', 210, 42);

  // Left sidebar: 5 nav items
  const navItems = ['≡ƒôè Dashboard', '≡ƒôï Tasks', '≡ƒôà Calendar', '≡ƒÆ¼ Messages', 'ΓÜÖ∩╕Å Settings'];
...
function createIpadTexture() {
  ...
  ctx.fillText('≡ƒì» MediaHive', 24, 38);
  ...
  const sidebarItems = [
    { text: '≡ƒôï Tasks', active: true },
    { text: '≡ƒôà Calendar', active: false },
    { text: '≡ƒôü Assets', active: false },
    { text: '≡ƒæÑ Team', active: false }
  ];
...
function createIphoneTexture() {
  ...
  ctx.fillStyle = '#F5A623';
  ctx.font = 'bold 22px sans-serif';
  ctx.fillText('≡ƒì» MediaHive', 24, 98);
  ...
  // Icons
  ctx.fillStyle = '#F5A623';
  ctx.fillText('≡ƒôè', 48, 790);

  ctx.fillStyle = '#9ca3af';
  ctx.fillText('≡ƒôï', 138, 790);
  ctx.fillText('≡ƒÆ¼', 228, 790);
  ctx.fillText('ΓÜÖ∩╕Å', 318, 790);

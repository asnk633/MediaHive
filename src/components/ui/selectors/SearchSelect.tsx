          ...
          <div className="bg-[var(--glass-liquid-bg)] backdrop-blur-2xl border border-border rounded-[20px] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <Command className="bg-transparent">
              <CommandInput 
                ...
                className="h-12 border-b border-foreground/5 bg-transparent text-foreground font-medium placeholder:text-foreground/80 px-4"
              />
              <CommandList className="max-h-[300px] p-2">
                <CommandEmpty className="py-6 text-center text-foreground/80 text-xs font-black uppercase tracking-widest">
                  No matches found.
                </CommandEmpty>
                <CommandGroup>
                  {options.map((option) => (
                    <CommandItem
                      ...
                      className={cn(
                        ...
                        value === option.id
                          ...
                          : "text-foreground/80 hover:bg-foreground/5 hover:text-foreground aria-selected:bg-foreground/5 aria-selected:text-foreground"
                      )}
                    >

...
export const MemberActivityFeed = ({ tasks }: MemberActivityFeedProps) => {
    ...
    return (
        <div className="bg-foreground/5 backdrop-blur-md border border-[#ffffff1a] rounded-2xl p-5 shadow-xl animate-in fade-in duration-700">

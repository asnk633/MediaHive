...
export const InstitutionalPulseRow = ({ dashboardMetrics }: InstitutionalPulseRowProps) => {
    ...
    return (
        <div className="pt-2 border-t border-white/5 grid grid-cols-1 md:grid-cols-4 gap-[18px] py-[10px] px-4 items-center">
            {/* 1. Weekly Events */}
            <div className="flex items-center gap-4 group cursor-default">
                <div className="w-8 h-8 rounded-[18px] bg-white/5 flex items-center justify-center text-white/20 group-hover:bg-blue-500/10 group-hover:text-blue-400 transition-all">
                    <Calendar size={16} />
                </div>
                <div>
                    <p className="text-[8px] font-black text-white/10 uppercase tracking-[0.2em]">Weekly Events</p>
            ...
            {/* 2. Global Overdue */}
            <div className="flex items-center gap-4 group cursor-default">
                <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-white/20 group-hover:bg-red-500/10 group-hover:text-red-400 transition-all">
                    <Activity size={16} />
                </div>
                <div>
                    <p className="text-[8px] font-black text-white/10 uppercase tracking-[0.2em]">Global Overdue</p>
                    <p className="text-sm font-bold text-white/40 group-hover:text-white/60 transition-colors">
            ...
            {/* 3. Pending Approvals */}
            <div className="flex items-center gap-4 group cursor-default">
                <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-white/20 group-hover:bg-amber-500/10 group-hover:text-amber-400 transition-all">
                    <Flag size={16} />
                </div>
                <div>
                    <p className="text-[8px] font-black text-white/10 uppercase tracking-[0.2em]">Approvals</p>
                    <p className="text-sm font-bold text-white/40 group-hover:text-white/60 transition-colors">
            ...
            <div className="flex items-center gap-4 group cursor-default">
                ...
                <div>
                    <p className="text-[8px] font-black text-white/10 uppercase tracking-[0.2em]">Created By Me</p>
                    <p className="text-sm font-bold text-white/40 group-hover:text-white/60 transition-colors">

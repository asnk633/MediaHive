                ...
                {loading ? (
                    ...
                    <div className="space-y-3">
                        {activities.map((act) => (
                            <div
                                key={act.id}
                                className="flex items-center gap-4 p-4 bg-[#11131F] border border-white/5 rounded-xl hover:bg-white/5 transition-colors"
                            >
                                ...
                                <div className="text-xs text-white/30 whitespace-nowrap flex items-center gap-1.5">
                                    <Clock size={12} />

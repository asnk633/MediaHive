...
export function MemberProfilePage() {
    ...
    return (
        <div className="min-h-screen bg-background relative overflow-hidden pb-20 lg:pb-0">
            <div className="bg-foreground/5 backdrop-blur-md border border-[#ffffff1a] rounded-3xl p-8 mb-8">
                <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex flex-col gap-3 w-full md:w-auto">
                        <button
                            ...
                            className="bg-blue-600 hover:bg-blue-500 text-foreground px-6 py-3 rounded-xl font-medium transition-all shadow-lg shadow-blue-500/20 active:scale-95 flex items-center justify-center gap-2"
                        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="bg-slate-800/30 border border-foreground/5 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="p-2 bg-blue-500/20 text-blue-400 rounded-lg">
                            <Clock size={20} />
                        </div>
                        <h3 className="text-lg font-semibold text-foreground">Active Requests</h3>
                    </div>
            ...
            <div className="bg-foreground/5 backdrop-blur-md border border-foreground/5 rounded-3xl p-6">
                    ...
                    {loading ? (
                        ...
                        recentActivity.map(task => (
                            <div key={task.id}
                                ...
                                className="flex items-center justify-between p-4 bg-foreground/5 rounded-xl border border-foreground/5 hover:bg-foreground/10 transition-colors cursor-pointer group"
                            >

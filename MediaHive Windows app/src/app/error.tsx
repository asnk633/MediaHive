        ...
        <div className="w-full h-full flex flex-col items-center justify-center relative z-10 p-6">
          ...
          >
            ...
            <div className="flex flex-col items-center text-center gap-6">
              ...
              <div className="w-16 h-16 rounded-full bg-amber-500/10 border border-amber-500/20 flex items-center justify-center shadow-lg shadow-amber-500/5">
                <AlertTriangle size={28} className="text-amber-400 animate-pulse" />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-zinc-400 text-xs leading-relaxed font-medium m-0 px-2 line-clamp-3">
              ...
              <div className="w-full flex flex-col gap-2.5 mt-2">
                <button
                  type="button"
                  onClick={() => reset()}
                  className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-orange-600 hover:brightness-110 text-white font-bold text-xs py-3.5 rounded-xl transition-all shadow-lg shadow-amber-500/10 hover:shadow-amber-500/20 cursor-pointer active:scale-[0.98]"
                >
                  <RotateCcw size={13} />
                ...
                <button
                  type="button"
                  onClick={() => router.push("/")}
                  className="w-full flex items-center justify-center gap-2 border border-zinc-800 bg-zinc-900/60 hover:bg-zinc-800/60 text-white font-bold text-xs py-3 rounded-xl transition-all cursor-pointer active:scale-[0.98]"
                >
                  <Home size={13} />

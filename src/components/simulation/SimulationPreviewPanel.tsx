        ...
        <div className="bg-gray-800 border-t border-gray-700 px-4 py-3">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={onClose}
                className="flex-1 px-3 py-2 bg-gray-700 hover:bg-gray-600 text-gray-300 text-xs rounded transition-colors flex items-center justify-center gap-1"
              >
                <X className="h-3 w-3" />
                Close
              </button>
              ...
              <button
                ...
                className="flex-1 px-3 py-2 bg-gray-700 hover:bg-gray-600 text-gray-300 text-xs rounded transition-colors"
              >
                Back to Live
              </button>
            </div>
    ...
    <div className="space-y-6">
      <div className="bg-gray-800/30 border border-gray-700 rounded-lg p-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            <h4 className="text-sm font-medium text-gray-300 mb-2">Implications</h4>
  ...
  return (
    <div className="bg-gray-800/30 border border-gray-700 rounded-lg p-4">
      ...
      <div className="space-y-3">
        <div>
          <h5 className="text-sm font-medium text-gray-300 mb-1">Key Implications</h5>
          <ul className="space-y-1">
            {result.outcome.implications.slice(0, 3).map((implication, index) => (
              <li key={index} className="text-gray-400 text-sm flex items-start gap-1">
        ...
        <div>
          <h5 className="text-sm font-medium text-gray-300 mb-1">Outcome</h5>

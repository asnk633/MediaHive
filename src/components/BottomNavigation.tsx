...
export default function BottomNavigation() {
  ...
  return (
    <>
      <div className="fixed top-24 left-1/2 -translate-x-1/2 bg-red-600 text-white px-4 py-2 rounded-full z-[9999] font-bold shadow-xl animate-pulse">
        DEBUG: DEPLOYMENT ACTIVE
      </div>
      <div

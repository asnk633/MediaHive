...
export const DueSoonWidget = ({ tasks, userRole }: DueSoonWidgetProps) => {
    ...
    return (
        <div className="tier3-surface rounded-[18px] p-6">
            ...
            <div className="space-y-3">
                {dueSoonTasks.map((task) => (
                    <div
                        ...
                        className="group flex flex-col gap-2 p-3 rounded-[18px] hover:bg-surface cursor-pointer transition-colors border border-transparent hover:border-border-soft"
                    >

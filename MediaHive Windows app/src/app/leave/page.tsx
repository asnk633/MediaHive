...
export default function LeaveRequestPage() {
  ...
  const balanceCards = [
    { type: "Annual Leave", balance: `${balances.annual || balances.Annual || 0} days left`, color: "text-[var(--accent)] border-[var(--accent)]/20" },
    { type: "Sick Leave", balance: `${balances.sick || balances.Sick || 0} days left`, color: "text-zinc-200 border-zinc-700" },
    { type: "Personal Leave", balance: `${balances.personal || balances.Personal || 0} days left`, color: "text-zinc-450 border-zinc-800" }
  ];
    ...
    <div className="flex flex-col gap-6 max-w-[1400px] mx-auto w-full pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {balanceCards.map((bal, idx) => (
          <div key={idx} className={`studio-card p-5 flex items-center justify-between relative overflow-hidden group hover:border-zinc-700`}>
            <div>
            ...
            <div className="p-2.5 rounded-xl bg-zinc-800/40 border border-white/5 text-zinc-500 group-hover:text-[var(--accent)] group-hover:border-[var(--accent)]/25 transition-all">
              <Plane size={18} />
            </div>
          </div>
        ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        {/* Request Form */}
        <div className="lg:col-span-2 studio-panel rounded-2xl p-6 flex flex-col gap-5">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <select 
                  ...
                  className="bg-zinc-950/40 border border-white/5 rounded-xl px-3.5 py-2.5 text-xs text-zinc-200 focus:outline-none focus:border-[var(--accent)]/55 transition-all font-sans"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <input 
                  ...
                  className="bg-zinc-950/40 border border-white/5 rounded-xl px-3.5 py-2 text-xs text-zinc-200 focus:outline-none focus:border-[var(--accent)]/55 transition-all font-sans [color-scheme:dark]"
                />
              </div>
              <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea 
                ...
                rows={3}
                className="bg-zinc-950/40 border border-white/5 rounded-xl px-3.5 py-2 text-xs text-zinc-200 focus:outline-none focus:border-[var(--accent)]/55 transition-all font-sans resize-none"
              />
            </div>

            <button 
              type="submit" disabled={submitting}
              className="flex items-center justify-center gap-2 bg-[var(--accent)] hover:bg-[var(--accent-hover)] text-zinc-950 text-xs font-bold py-2.5 rounded-full transition-all cursor-pointer mt-2 disabled:opacity-50"
            >
              <Send size={13} />
        ...
        {/* Request History */}
        <div className="studio-panel rounded-2xl p-5 flex flex-col gap-4 lg:sticky lg:top-6">

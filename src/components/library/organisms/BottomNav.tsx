...
export const BottomNav = ({ activeTab = 'home' }: { activeTab?: string }) => {
    ...
    return (
        <motion.nav
            ...
            className="fixed bottom-0 left-0 w-full bg-white/95 backdrop-blur-xl border-t border-gray-200/50 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] flex items-center justify-around z-30 px-4"
            style={{

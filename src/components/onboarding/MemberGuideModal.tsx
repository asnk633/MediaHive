...
export function MemberGuideModal({ open, onClose }: MemberGuideModalProps) {
    if (!open) return null;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="w-full max-w-2xl bg-card border border-border rounded-2xl shadow-strong flex flex-col max-h-[90vh]">
                ...
                <div className="p-4 border-b border-border flex items-center justify-between">
                    <h2 className="text-lg font-bold text-foreground">Member User Guide</h2>
                        ...
                        <div className="space-y-6">
                            <section>
                                ...
                                <div className="bg-yellow-500/10 border-l-4 border-yellow-500 p-3 mb-4 rounded-r-lg">
                                    <p className="text-yellow-200 text-xs font-semibold">🚧 Important: You must register to use this app. There is no anonymous access.</p>
                                </div>
                            ...
                            <section>
                                <h3 className="text-primary font-bold text-lg mb-2">2. Member Role Limitations</h3>
                                <p className="text-muted-foreground mb-3">As a Member user, your account has limited permissions to ensure an organized workflow.</p>
                                <ul className="space-y-2 text-sm">
                                    ...
                                    <li className="flex gap-2">❌ <span className="text-muted-foreground"><strong>You Cannot Set Priority:</strong> Member users cannot set priority. Admin manages priority internally.</span></li>

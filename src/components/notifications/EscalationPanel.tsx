        ...
        <div className="rounded-xl bg-red-500/10 border border-red-500/30 p-4 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {stats.overdue > 0 && (
                    <div className="bg-white/5 p-3 rounded-lg border border-white/10 flex items-center justify-between">
                        ...
                        <span className="bg-red-500/20 text-red-300 text-xs font-bold px-2 py-1 rounded-full">
                            {stats.overdue}
                        </span>
                    </div>
                )}
                ...
                {stats.stale > 0 && (
                    <div className="bg-white/5 p-3 rounded-lg border border-white/10 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-gray-300">Stale Tasks</span>
                        </div>
                        <span className="bg-orange-500/20 text-orange-300 text-xs font-bold px-2 py-1 rounded-full">
                            {stats.stale}
                        </span>
                    </div>
                )}
                ...
                {stats.inventory > 0 && (
                    <div className="bg-white/5 p-3 rounded-lg border border-white/10 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-gray-300">Inventory Alerts</span>
                        </div>
            ...
            <div className="mt-4 flex justify-end">
                <Link
                    ...
                    className="text-sm bg-red-500/20 hover:bg-red-500/30 px-3 py-1.5 rounded-lg transition-colors text-red-300 font-medium"
                >
                    View Overdue Tasks →
                </Link>
            </div>

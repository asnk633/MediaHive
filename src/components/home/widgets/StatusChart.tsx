...
export const StatusChart = ({ stats }: StatusChartProps) => {
    ...
    if (!isReady) {
        return (
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-5 shadow-xl h-[350px] animate-pulse" />
        );
    }

    if (activeData.length === 0) {
        return (
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-5 shadow-xl h-[350px] flex items-center justify-center">
    ...
    return (
        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-5 shadow-xl flex flex-col h-[350px]">

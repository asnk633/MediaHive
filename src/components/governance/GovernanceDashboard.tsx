            ...
            <PageHeader
                ...
                actions={
                    <button
                        ...
                        className="h-11 px-6 bg-blue-600 hover:bg-blue-500 text-white rounded-[20px] font-bold text-sm transition-all shadow-lg shadow-blue-500/20 flex items-center gap-2 group"
                    >
                ...
                <section className="bg-blue-500/5 border border-blue-500/10 rounded-[48px] p-10 relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-2xl font-bold text-white tracking-tight">Understanding Conflict Resolution</h3>
                            ...
                            <div className="flex gap-4">
                                <div className="px-4 py-2 bg-white/5 rounded-2xl text-[10px] font-black uppercase tracking-widest text-white/50 border border-white/10">
